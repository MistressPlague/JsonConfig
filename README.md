...
**NOTE: Use Of This Requires You Add Json.Net AKA Newtonsoft.Json To Your Project. Right Click References, Add Reference, Click Assemblies Then In The Search Bar At The Right, Search Json. You Should See Json.NET NET 4.0 - Add This Reference.**
